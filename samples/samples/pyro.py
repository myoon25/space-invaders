"""
A Game-like Controller module for lecture demos.

You should refer to this file to see how to had and remove
objects as they die or go offscreen.
...
class Pyro(GameApp):
    """
    This class is a controller for lecture demos about
    interaction and animation.

    This class extends GameApp and implements the various
    methods necessary for an interactive application.
    ...
    * The on_touch methods handle mouse (or finger) input.
    ...
    #
    # Attribute _last: the last position clicked
    # Invariant: _last is a GPoint,  or None if mouse not down last frame
...
class Spark(GEllipse):
    """
    A class to represent particles created in shell
    explosions.
    """
    # HIDDEN ATTRIBUTES
...
class Rocket(GEllipse):
    """
    A class to represent rockets that will generate
    explosions later.
    """
    # HIDDEN ATTRIBUTES
